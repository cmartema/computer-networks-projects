...
# global variables
uni = "cjm2301" # put your UNI
key_filename = "/Users/chris.marte/.ssh/csee4119-s24" # replace with the path to your ssh key locally. You may need to use an absolute path and avoid using "~" to denote your home directory
vm_ex_ips = ['34.67.4.187', '34.66.254.250', '34.133.49.183', '34.31.151.40'] # replace with the external IPs of your VMs, as a list of strings
internal_port = 50000
external_port = 60000
